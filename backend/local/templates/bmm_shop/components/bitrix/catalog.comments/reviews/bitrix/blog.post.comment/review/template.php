...
<div id="blg-comment-<?=$arParams["ID"]?>">
    <?if(isset($arResult['Comments']) && count($arResult['Comments']) === 1):?>
        <input type="hidden" id="review_comment_id" value="<?=key($arResult['Comments'])?>">
    <?endif;?>
                            ...
                            <div class="media-body">
                                <h5 class="mt-0 mb-1">
                                    ...
                                    <span class="product__review_info">
                                        ...
                                        <span id="<?=$comment['ID']?>" class="product__info_rating">
...
<?if($arResult["is_ajax_post"] != "Y"):?>
        ...
        <div class="product__info_section_actions">
            ...
            <? if($USER->IsAuthorized()):?>
                <a id="add_new_review" class="product__info_section_actions-new <?=$classDisabled?>" href="javascript:void(0)" onclick="addNewReview('0', <?=$arParams["ID"]?>)">
