...
<div class="catalog__controls">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="sortButton">
            ...
            <a class="dropdown-item" href="<?=$APPLICATION->GetCurPage().'?'.$arResult["PRICE_DOWN"];?>">Сначала дорогие</a>
        </div>
    </div>
</div>
<div> <? // wrapper ?>
    <div>
        <div class="catalog__main_items row <?=($blockCode === 'books')?'':'no-image-shadow'?>" data-entity="<?=$containerName?>">
            <!-- items-container -->
            <?
