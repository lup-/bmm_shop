...
if ($arParams['IBLOCK_ID'] === $_ENV['BOOK_BLOCK_ID']) {
    ...
    $APPLICATION->SetTitle("${sectionName}: купить с доставкой по Москве, Санкт-Петербургу и России — торговый дом БММ");
    $APPLICATION->SetPageProperty("description", "✓ Более ${productCount} товаров в категории «${sectionName}» в торговом доме БММ по цене от ${minPrice} руб. 🚚 Доставка по Москве, Санкт-Петербургу и во все регионы РФ.");
}