...
<div>
    ...
    $elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'detail_element', $componentElementParams,
			$component
		);
    ...
    if ($elementId > 0)
		{
            ...
            if(!empty($props['SERIES']['VALUE']) && $arParams['TEMPLATE_THEME'] === 'books'){
                $GLOBALS['arrFilter']  = array('PROPERTY_SERIES' => $props['SERIES']['VALUE']);
			...
			if(!empty($props['AUTHOR']['VALUE']) && $arParams['TEMPLATE_THEME'] === 'books'){
                $GLOBALS['arrFilter']  = array('PROPERTY_AUTHOR' => $props['AUTHOR']['VALUE']);
			    ?>
                    <? $APPLICATION->IncludeComponent('bitrix:catalog.section', 'block_slider', array(
                        'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
                        'IBLOCK_ID' => $arParams['IBLOCK_ID'],
