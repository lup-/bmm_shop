...
### Для первой загрузки всех товаров
 - Все действия выполняются внутри контейнера backend
 - docker-compose exec backend bash 
 
### Шаг 1
 - composer install
 
### Шаг 2 зайти в папку local
 - php setup.php
 
### Шаг 3 зайти в папку local/cron и оттуда запустить
 - php import.php
 - Ждать придется минут 25
 - в папке log создадуться файлы debug.php и element.php, в которых будут результаты загрузки
